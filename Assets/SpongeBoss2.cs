...
public class SpongeBoss2 : MonoBehaviour
{
  ...
  void Update()
  {
    ...
    if (health < 40)
    {
      gameObject.GetComponent<SpriteRenderer>().sprite = nextState;
      //gameObject.GetComponent<spongeBoss>().changeState();

    }
    if (gameObject.transform.position.x >= 38f)
    {
