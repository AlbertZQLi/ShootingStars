...
public class bulletMove : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.name == "Spongebob" && this.tag == "Nuke")
        {

          other.gameObject.GetComponent<SpongeBoss2>().hit(3);
          Destroy(gameObject);

        }

        if (other.gameObject.name == "Spongebob" && this.tag == "Bullet")
        {

          other.gameObject.GetComponent<SpongeBoss2>().hit(1);
          Destroy(gameObject);
